(function() {
    ...
    function modulePage() {
        ...
        displayRelatedLearningPaths(moduleId);
    }
    ...
    function displayRelatedLearningPaths(moduleId) {
        getModule(msDocs.data.userLocale, moduleId).then(function(result) {
            return contentLoaded.then(function() {
                document.getElementById("parent-learning-paths").innerHTML = template$2(result.parents);
            });
        }).catch(function(error) {});
    }
    var template$2 = function(paths) {
